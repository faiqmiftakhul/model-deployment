...
# helper function untuk mendapatkan nilai angka dari pilihan variabel kategorikal
...
def run_ml_app():
    ...
    # encoding untuk nilai2 input yg dimasukkan user
    encoded_result = []
    ...
    if prediction == 1:
        st.success('Congrats, the employee get promotion!')
